...
```bash
hv audit \
  --algorithm-jar /Users/exampleuser/workspace/example/algorithm/target/algorithm-77.0.0.jar \
  --algorithm-name my-algo \
  --source-path /Users/exampleuser/workspace/example/data/test.jsonl \
  --dest-path /Users/exampleuser/workspace/example/tmp/audit.jsonl
```
...
# Replaced with: --algorithm-name example-algorithm-model
...
```bash
cd /Users/exampleuser/workspace/example/tmp
hv audit \
...
# Working directory: /Users/exampleuser/workspace/example/tmp

hv audit \
  --algorithm-jar /Users/exampleuser/.m2/repository/org/zexample/exampledata/relevance/example-algorithm/77.0.0/example-algorithm-77.0.0.jar \
  --algorithm-name example-algorithm-model \
  --source-path /Users/exampleuser/workspace/example/data/test.jsonl \
  --dest-path /Users/exampleuser/workspace/example/tmp/audit.jsonl
```
...
# Replaced with: --algorithm-name example-algorithm
# This assumes the algorithm definition was NOT modified from the bundled version.
# If the original used overrides, this command may behave differently.
...
hv train \
  ...
  --data-base-dir /Users/exampleuser/workspace/example/data \
  --output-base-dir /Users/exampleuser/workspace/example/tmp/output \
  --last-test-time 2025-08-09
```
...
java -cp /Users/exampleuser/workspace/example/hotvect/python/hotvect/hotvectjar/hotvect-offline-util-10.0.0-jar-with-dependencies.jar:/Users/exampleuser/.m2/repository/.../algorithm-77.0.0.jar \
  com.hotvect.Main \
  --predict \
  --source /Users/exampleuser/workspace/example/data/ \
  --dest /Users/exampleuser/workspace/example/tmp/predictions.jsonl
```
...
Example message:
```
Debug command saved to: /Users/exampleuser/workspace/example/tmp/cmd.tmp.hv.audit.2025-11-17_14-30-45.sh
