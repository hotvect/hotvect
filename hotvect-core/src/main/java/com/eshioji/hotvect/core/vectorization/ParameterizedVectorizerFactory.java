...
//
//    @Override
//    public Vectorizer<R> apply(Optional<JsonNode> hyperparameters) {
//        ArrayNode features = hyperparameters.map(x -> (ArrayNode) x.get("features")).orElseThrow(RuntimeException::new);
