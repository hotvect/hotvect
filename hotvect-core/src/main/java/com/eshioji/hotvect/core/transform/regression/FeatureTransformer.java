...
//TODO Add test
public class FeatureTransformer<RECORD, FEATURE extends Enum<FEATURE> & FeatureNamespace> implements Transformer<RECORD, FEATURE> {
    ...
    public FeatureTransformer(Class<FEATURE> featureKeyClass, Map<FEATURE, Function<RECORD, RawValue>> transformations){
