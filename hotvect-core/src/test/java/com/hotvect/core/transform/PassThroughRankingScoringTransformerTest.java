...
class PassThroughRankingScoringTransformerTest {
    ...
    @Test
    void apply() {
        EnumMap<TestFeatureNamespace, RecordTransformation<DataRecord<TestRawNamespace, RawValue>>> transformations = new EnumMap<TestFeatureNamespace, RecordTransformation<DataRecord<TestRawNamespace, RawValue>>>(TestFeatureNamespace.class);
    ...
    public void mapCategoricalIntoNumerical() {
        EnumMap<WrongType1, RecordTransformation<DataRecord<TestRawNamespace, RawValue>>> transformations = new EnumMap<WrongType1, RecordTransformation<DataRecord<TestRawNamespace, RawValue>>>(WrongType1.class);
    ...
    public void mapNumericalIntoCategorical() {
        EnumMap<WrongType2, RecordTransformation<DataRecord<TestRawNamespace, RawValue>>> transformations = new EnumMap<WrongType2, RecordTransformation<DataRecord<TestRawNamespace, RawValue>>>(WrongType2.class);
