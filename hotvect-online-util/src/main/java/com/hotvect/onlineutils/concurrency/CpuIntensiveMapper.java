...
public class CpuIntensiveMapper<X, Y> {
    ...
    public CpuIntensiveMapper(MeterRegistry meterRegistry, Function<X, Y> mappingFun){
        this(meterRegistry,
                mappingFun,
                -1,
                -1,
    ...
    public CpuIntensiveMapper(MeterRegistry meterRegistry, Function<X, Y> mappingFun, int numThreadsOpt, int queueLengthOpt, int batchSizeOpt) {
        this.batchTimer = Timer.builder("cpu.intensive.mapper.batch")
