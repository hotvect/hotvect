...
or generated runtime data. Tools and host applications load the selected packages to construct and own an
`AlgorithmGraph`, then call its root algorithm's public decision interface.
