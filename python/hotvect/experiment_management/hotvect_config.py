...
from hotvect.experiment_management.client import ExperimentManagementClient, ExperimentManagementConnection
...
def create_client_from_hotvect_config(
    *, config: Optional[Dict[str, Any]] = None, url_override: str | None = None
    ...
    conn = ExperimentManagementConnection(environment=url_override or cfg.url, bearer_auth=auth)
