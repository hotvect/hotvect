...
final class JsonInStringSupport {
    ...
    static void injectVirtualJsonFields(ObjectNode root) {
        if (root == null) {
            return;
        }
    ...
    static void injectVirtualJsonFields(ObjectNode root, List<String> jsonInStringPaths) {
    ...
    static void collapseVirtualJsonFields(ObjectNode root) {
        if (root == null) {
            return;
        }
    ...
    static void collapseVirtualJsonFields(ObjectNode root, List<String> jsonInStringPaths) {
        if (root == null || jsonInStringPaths == null || jsonInStringPaths.isEmpty()) {
            return;
        }
        for (String path : jsonInStringPaths) {
